...
# read.csv(file.choose()) ##but this approach is not reproducible
...
> ANSWER: it is found in the metadata folder. The folder serves to provide extra information on the dataset. It is separated from the data folder to avoid confusion.
...
> Answer: if they are numeric, they become NA data cells
...
USGS.flow.data$datetime <- as.Date(USGS.flow.data$datetime, format = "%m/%d/%y") ##the date format matters
```
