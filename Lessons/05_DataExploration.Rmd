...
```{r, fig.height = 3, fig.width = 4}
#examples of different line types & colors
#search "r color" for more colors
#search "r line types" for more line types
ggplot(USGS.flow.data) +
...
#
ggplot(USGS.flow.data) +
  geom_freqpoly(aes(x = gage.height.mean
                    , color = gage.height.mean.approval
                    ), 
                bins = 50) +
  scale_x_continuous(limits = c(0, 10)) +
...
# boxplot against mean gage height
ggplot(USGS.flow.data) +
